...
export const translations = {
  en: {
    ...
    elevenlabsTranscription: "Eleven Labs Scribe (Requires API Key)",
    apiKeys: "API Keys",
    openAIAPIKey: "OpenAI API Key",
    mistralAPIKey: "Mistral AI API Key",
    elevenlabsAPIKey: "Eleven Labs API Key",
    ...
    elevenlabsTranscription: "Eleven Labs Scribe (Vaatii API-avaimen)",
    apiKeys: "API-avaimet",
    openAIAPIKey: "OpenAI API-avain",
    mistralAPIKey: "Mistral AI API-avain",
    elevenlabsAPIKey: "Eleven Labs API-avain",
